-- ====================================================================
-- MURUGAN APP - QUICK DATABASE SETUP
-- ====================================================================
-- 
-- INSTRUCTIONS:
...
-- 7. Return to Admin Panel and refresh
--
-- ====================================================================
...
-- Photos
CREATE INDEX IF NOT EXISTS idx_photos_publish_status ON photos(publish_status);
CREATE INDEX IF NOT EXISTS idx_photos_category_id ON photos(category_id);
CREATE INDEX IF NOT EXISTS idx_photos_tags ON photos USING GIN(tags);
CREATE INDEX IF NOT EXISTS idx_photos_created_at ON photos(created_at DESC);

-- Sparkle
CREATE INDEX IF NOT EXISTS idx_sparkle_publish_status ON sparkle(publish_status);
CREATE INDEX IF NOT EXISTS idx_sparkle_category_id ON sparkle(category_id);
CREATE INDEX IF NOT EXISTS idx_sparkle_is_featured ON sparkle(is_featured);
CREATE INDEX IF NOT EXISTS idx_sparkle_tags ON sparkle USING GIN(tags);
CREATE INDEX IF NOT EXISTS idx_sparkle_published_at ON sparkle(published_at DESC);
...
-- Logs
CREATE INDEX IF NOT EXISTS idx_downloads_log_user_id ON downloads_log(user_id);
CREATE INDEX IF NOT EXISTS idx_downloads_log_content ON downloads_log(content_type, content_id);
CREATE INDEX IF NOT EXISTS idx_likes_log_user_content ON likes_log(user_id, content_type, content_id);
...
DROP TRIGGER IF EXISTS update_sparkle_updated_at ON sparkle;
...
DROP POLICY IF EXISTS "Public can view published banners" ON banners;
...
DROP POLICY IF EXISTS "Public can view published wallpapers" ON wallpapers;
...
DROP POLICY IF EXISTS "Public can view published sparkle" ON sparkle;
...
DROP POLICY IF EXISTS "Users can create own chats" ON ai_chats;
...
DROP POLICY IF EXISTS "Users can manage own likes" ON likes_log;
...
DROP POLICY IF EXISTS "Users can create download logs" ON downloads_log;
...
SELECT '✅ DATABASE SETUP COMPLETE! All tables, indexes, triggers, and policies created successfully!' as message;