...
export function SponsoredCard({ isActive }: SponsoredCardProps) {
    return (
        <div className="w-full h-full bg-black flex flex-col justify-center items-center">
            ...
            {/* Card Content */}
            <div className="z-10 w-full max-w-sm bg-white rounded-xl overflow-hidden shadow-2xl mx-4">
                {/* Header */}
                <div className="flex items-center justify-between px-3 py-3 border-b border-gray-100">
                    ...
                    <Button variant="ghost" className="text-sm font-semibold text-blue-500 hover:text-blue-600">
                        Follow
                    </Button>
                </div>
                ...
                <div className="w-full relative aspect-square bg-gray-100">
                    ...
                    {/* Learn More Overlay */}
                    <div className="absolute bottom-0 left-0 right-0 bg-[#262626] py-3 px-4 flex items-center justify-between cursor-pointer active:bg-[#303030]">
                        <span className="text-[14px] font-semibold text-white">Install Now</span>
