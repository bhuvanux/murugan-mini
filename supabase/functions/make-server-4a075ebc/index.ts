...
// NOTIFICATIONS
// ========================================
import * as notificationApi from "./notification-routes.tsx";

app.get("/make-server-4a075ebc/api/notifications", notificationApi.getNotifications);
app.post("/make-server-4a075ebc/api/notifications", notificationApi.createNotification);
app.put("/make-server-4a075ebc/api/notifications/:id", notificationApi.updateNotification);
app.delete("/make-server-4a075ebc/api/notifications/:id", notificationApi.deleteNotification);
app.post("/make-server-4a075ebc/api/notifications/:id/send", notificationApi.sendNotification);
app.post("/make-server-4a075ebc/api/upload/notification", notificationApi.uploadNotification);
app.get("/make-server-4a075ebc/api/notifications/stats", notificationApi.getNotificationStats);
app.get("/make-server-4a075ebc/api/notifications/:id/analytics", notificationApi.getNotificationAnalytics);
app.post("/make-server-4a075ebc/api/notifications/bulk-delete", notificationApi.bulkDeleteNotifications);
